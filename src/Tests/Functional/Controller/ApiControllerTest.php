...
namespace Evrinoma\SocialBundle\Tests\Functional\Controller;

use Evrinoma\SocialBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.social.test.functional.action.social';
    ...
    {
        return [FixtureInterface::SOCIAL_FIXTURES];
    }
}
