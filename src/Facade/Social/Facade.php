...
namespace Evrinoma\SocialBundle\Facade\Social;

use Evrinoma\SocialBundle\Manager\CommandManagerInterface;
use Evrinoma\SocialBundle\Manager\QueryManagerInterface;
use Evrinoma\SocialBundle\PreValidator\DtoPreValidatorInterface;
